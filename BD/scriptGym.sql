...
INSERT INTO PROTOCOLOAVAFISICA(IDPROTOCOLOAVAFISICA, DESCRICAOPROTOCOLOAVAFISICA, OBS) VALUES(1,'FAULKNER: 4 DOBRAS', 'Tríceps, subescapular, supra-ilíaca e abdominal.');
INSERT INTO PROTOCOLOAVAFISICA(IDPROTOCOLOAVAFISICA, DESCRICAOPROTOCOLOAVAFISICA, OBS) VALUES(2,'POLLOCK: 3 DOBRAS', 'Tríceps, supra-ilíaca, coxa.');
INSERT INTO PROTOCOLOAVAFISICA(IDPROTOCOLOAVAFISICA, DESCRICAOPROTOCOLOAVAFISICA, OBS) VALUES(3,'POLLOCK: 7 DOBRAS', 'Subescapular, tríceps, peitoral, axilar-média, supra-ilíaca, abdômen e coxa.');
INSERT INTO PROTOCOLOAVAFISICA(IDPROTOCOLOAVAFISICA, DESCRICAOPROTOCOLOAVAFISICA, OBS) VALUES(4,'GUEDES: 3 DOBRAS', 'Homens : Tríceps, suprai-líaca e abdominal. | Mulheres: Subescapular, supra-ilíaca e coxa proximal.');

-- CADASTRA MODALIDADE
INSERT INTO MODALIDADE(IDMODALIDADE, DESCRICAOMODALIDADE, VALOR) VALUES(1,'MUSCULAÇÃO', 0.00);
...
-- F01001/FALUNO
INSERT INTO SEGURANCA(IDSEGURANCA,IDINTERFACE,IDTIPOUSUARIO, CADASTRAR, ALTERAR, CONSULTAR,EXCLUIR) VALUES(1,1,1,1,1,1,1); /*admin*/
INSERT INTO SEGURANCA(IDSEGURANCA,IDINTERFACE,IDTIPOUSUARIO, CADASTRAR, ALTERAR, CONSULTAR,EXCLUIR) VALUES(2,1,2,0,1,1,0); /*instrutor*/
INSERT INTO SEGURANCA(IDSEGURANCA,IDINTERFACE,IDTIPOUSUARIO, CADASTRAR, ALTERAR, CONSULTAR,EXCLUIR) VALUES(3,1,3,1,1,1,1); /*atendente*/
INSERT INTO SEGURANCA(IDSEGURANCA,IDINTERFACE,IDTIPOUSUARIO, CADASTRAR, ALTERAR, CONSULTAR,EXCLUIR) VALUES(4,1,4,0,1,1,0); /*Avaliador*/
-- F01002/FPAGAMENTO
