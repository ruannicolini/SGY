...
INSERT INTO `configuracaounidade` (`idConfiguracaoUnidade`, `cnpj`, `razaoSocial`, `nomeFantasia`, `telefone`, `vencimentoFicha`, `videoYoutube`, `avaAnamnese`, `avaFisica`, `avaPostural`, `avaDadosClinicos`, `servidorImagens`) VALUES (1,'10.101.010/1010-10','academia','academia','(33)3263-2920',3,1,1,1,0,0,0);
...
INSERT INTO `parametros` (`parametro`, `descricao`, `valor`) VALUES ('aluno',NULL,19),('AlunoPatologia',NULL,1),('Anamnese',NULL,13),('avaliacaofisica',NULL,11),('campolog',NULL,2842),('equipamento',NULL,24),('exercicio',NULL,36),('ficha',NULL,1),('fichaPreDefinida',NULL,7),('grupoexercicio',NULL,15),('idAlunoModalidade',NULL,1),('idFichaAluno',NULL,9),('logsistema',NULL,459),('modalidade',NULL,3),('pagamento',NULL,181),('patologia',NULL,7),('serie',NULL,1),('tipousuario',NULL,5),('usuario',NULL,5);
...
-- Dump completed on 2017-06-08 11:41:31
