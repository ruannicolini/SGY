...
begin
  ...
  //MENSAGEM DE CONFIRMAÇÃO - TESTE
  {
  SHOWMESSAGE(
  'DATA: ' +  DModule.cdsLogdataLog.AsString + #13 +
  'HORA: ' + DModule.cdsLoghoraLog.AsString + #13 +
  'NOME USUÁRIO : ' + DModule.cdsLognomeUsuario.AsString + #13 +
  'ID USUÁRIO : ' + DModule.cdsLogidUsuario.AsString + #13 +
  ...
  'TIPO OPERAÇÃO : ' + DModule.cdsLogtipoCRUD.AsString + #13
  );
  }
end;
