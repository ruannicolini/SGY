...
type
  TF01016 = class(TFBase)
    ...
    FDQuery1nivelExtresse: TStringField;
    FDQuery1nivelAtividadeFisicaAtual: TStringField;
    FDQuery1hs_alteracaoPressao: TBooleanField;
    FDQuery1hs_anemia: TBooleanField;
    FDQuery1hs_ansiedade: TBooleanField;
    FDQuery1hs_criseRespiratoria: TBooleanField;
    FDQuery1hs_colesterolElevado: TBooleanField;
    FDQuery1hs_sonoIrregular: TBooleanField;
    FDQuery1hs_diabetes: TBooleanField;
    FDQuery1hs_gastrite: TBooleanField;
    FDQuery1hs_problemaTireoide: TBooleanField;
    FDQuery1hs_tonturasConstantes: TBooleanField;
    FDQuery1hs_varises: TBooleanField;
    FDQuery1hs_taquicardia: TBooleanField;
    FDQuery1obsCirurgias: TStringField;
    FDQuery1obsDoresCronicas: TStringField;
    FDQuery1obsDoresAgudas: TStringField;
    ...
    ClientDataSet1nivelExtresse: TStringField;
    ClientDataSet1nivelAtividadeFisicaAtual: TStringField;
    ClientDataSet1hs_alteracaoPressao: TBooleanField;
    ClientDataSet1hs_anemia: TBooleanField;
    ClientDataSet1hs_ansiedade: TBooleanField;
    ClientDataSet1hs_criseRespiratoria: TBooleanField;
    ClientDataSet1hs_colesterolElevado: TBooleanField;
    ClientDataSet1hs_sonoIrregular: TBooleanField;
    ClientDataSet1hs_diabetes: TBooleanField;
    ClientDataSet1hs_gastrite: TBooleanField;
    ClientDataSet1hs_problemaTireoide: TBooleanField;
    ClientDataSet1hs_tonturasConstantes: TBooleanField;
    ClientDataSet1hs_varises: TBooleanField;
    ClientDataSet1hs_taquicardia: TBooleanField;
    ClientDataSet1obsCirurgias: TStringField;
    ClientDataSet1obsDoresCronicas: TStringField;
    ClientDataSet1obsDoresAgudas: TStringField;
