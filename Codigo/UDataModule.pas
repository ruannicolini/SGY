...
type
  TDModule = class(TDataModule)
    ...
    qAcessocadastrar: TShortintField;
    qAcessoalterar: TShortintField;
    qAcessoconsultar: TShortintField;
    qAcessoexcluir: TShortintField;
    ...
    cdsAcessocadastrar: TShortintField;
    cdsAcessoalterar: TShortintField;
    cdsAcessoconsultar: TShortintField;
    cdsAcessoexcluir: TShortintField;
